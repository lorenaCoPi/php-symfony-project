 ...
 */
final class Version20230717114035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rick_and_morty DROP location_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rick_and_morty ADD location_id INT NOT NULL');
    }
}
